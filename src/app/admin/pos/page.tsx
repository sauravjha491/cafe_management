...
export default function POSPage() {
  ...
  return (
    <div className="flex h-[calc(100vh-120px)] gap-6 overflow-hidden">
        ...
        <div className="bg-white p-6 rounded-[2rem] shadow-sm border border-gray-100 space-y-6">
          ...
          <div className="flex gap-2 overflow-x-auto no-scrollbar pb-2">
            <button
              ...
              className={cn(
                "px-6 py-2.5 rounded-xl text-sm font-black whitespace-nowrap transition-all uppercase tracking-widest",
        ...
        <div className="flex-1 overflow-y-auto no-scrollbar grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4 pb-4">
          {filteredProducts.map(product => (
            <motion.button
              ...
              className="bg-white p-4 rounded-[2rem] border border-gray-100 shadow-sm hover:shadow-xl hover:shadow-gray-200/50 transition-all text-left flex flex-col group relative overflow-hidden"
            >
              <div className="relative h-32 w-full rounded-2xl overflow-hidden mb-4">
                <Image src={product.image} alt={product.name} fill className="object-cover group-hover:scale-110 transition-transform duration-500" />
                {product.stock >= 0 && (
                  <div className={cn(
                    "absolute top-2 right-2 px-2 py-1 rounded-lg text-[10px] font-black uppercase",
              ...
              <p className="mt-auto font-black text-red-600">{settings.currency} {product.price.toLocaleString()}</p>
      ...
      {/* Right: Cart & Checkout */}
      <div className="w-[400px] bg-white rounded-[2.5rem] shadow-2xl border border-gray-100 flex flex-col">
        {/* Customer Section */}
              ...
              <div key={item.id} className="flex gap-4 group">
                ...
                <div className="flex-1 flex flex-col justify-between py-1">
                  <div className="flex justify-between items-start">
                    ...
                    <button onClick={() => removeFromCart(item.id)} className="opacity-0 group-hover:opacity-100 text-gray-400 hover:text-red-600 transition-all">
                      <X className="w-4 h-4" />
                    </button>
                  </div>
        ...
        <div className="p-4 border-t border-gray-50 flex gap-2">
          ...
          <div className="relative group">
            ...
            {/* Held Orders Popover */}
            <div className="absolute bottom-full right-0 mb-2 w-64 bg-white rounded-3xl shadow-2xl border border-gray-100 p-4 opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto transition-all">
        ...
        {/* Totals & Checkout */}
        <div className="p-6 bg-gray-50 rounded-b-[2.5rem] space-y-4">
